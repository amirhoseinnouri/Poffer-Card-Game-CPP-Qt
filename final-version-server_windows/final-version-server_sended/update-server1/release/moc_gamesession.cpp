...
template <> constexpr inline auto GameSession::qt_create_metaobjectdata<qt_meta_tag_ZN11GameSessionE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'gameFinished'
        QtMocHelpers::SignalData<void(const QString &, const GameHistory &, const QString &, const GameHistory &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 3 }, { 0x80000000 | 4, 5 }, { QMetaType::QString, 6 }, { 0x80000000 | 4, 7 },
        }}),
        // Slot 'playerMessage'
...
void GameSession::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->gameFinished((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<GameHistory>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<GameHistory>>(_a[4]))); break;
        case 1: _t->playerMessage(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameSession::*)(const QString & , const GameHistory & , const QString & , const GameHistory & )>(_a, &GameSession::gameFinished, 0))
            return;
    }
}
